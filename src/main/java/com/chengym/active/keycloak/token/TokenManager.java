package com.chengym.active.keycloak.token;

import com.chengym.active.keycloak.Config;
import com.chengym.active.keycloak.util.BasicAuthFilter;
...
public class TokenManager {
	...
	public AccessTokenResponse grantToken() {
		...
		synchronized (this) {
			log.info("{} get keycloak token",String.valueOf(expirationTime));
